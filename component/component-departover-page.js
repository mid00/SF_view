...
let DepartoverHtml = "<div class='component-container'>" +

    "<departover-windowList v-bind:TableNumData='TableNumData'></departover-windowList>" +
    "<departover-char-container></departover-char-container>" +
    "" +
    "</div>";


var ComponentDepartover=Vue.component("ComponentDepartover",{
    template:DepartoverHtml,
    data:function () {
        return {
