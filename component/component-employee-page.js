...
let EmployeeHtml = "<div class='component-container'>" +

    "<employee-windowList v-bind:TableNumData='TableNumData'></employee-windowList>" +
    "<employee-char-container></employee-char-container>" +
    "</div>";


var ComponentEmployee=Vue.component("ComponentEmployee",{
