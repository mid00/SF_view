...
let HotitemHtml = "<div class='component-container'>" +

        "<hotitem-windowList v-bind:TableNumData='TableNumData'></hotitem-windowList>" +
        "<hotitem-char-container></hotitem-char-container>" +
    "" +
    "</div>";


var ComponentHotitem=Vue.component("ComponentHotitem",{
    template:HotitemHtml,
    data:function () {
        return {
