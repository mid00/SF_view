...
let BusinessHtml = "<div class='component-container'>" +

        "<PositionBussTypeList v-bind:TableNumData='TableNumData'></PositionBussTypeList>" +
        "<char-container></char-container>" +
"</div>";

 
var ComponentBusiness=Vue.component("ComponentBusiness",{
    template:BusinessHtml,
    data:function () {
        return {
