/**柜员数据表格**/
Vue.component("employee-windowList",{
    template:"<container-div2000 width='2170px' height='955px'>" +
        "<span class='desk-title'>柜员数据</span>" +
...
/**柜员图表**/
Vue.component("employee-char-container",{
    template:"" +
        "<container-div2000 padding='26px' margin='left:30px' imaPathNum='4' width='2170px' height='955px'>" +
            "<poly-line subtitle='办件总汇' v-bind:ChartData='SendCharData'>" +
            "</poly-line>" +
        "" +
            "<avg-evaluation " +
                "TitleString='柜员满意率' " +
